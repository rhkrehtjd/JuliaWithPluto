...
# ╔═╡ c207c07a-b634-4432-a438-bb39ac7251ad
# ctrl + enter 누르면 아래로 셀 생성
# ctrl + m 누르면 마크다운으로 사용할 수 있음
# 빈 셀에서 backspace 누르면 셀 삭제
...
# ╔═╡ 84584103-cee8-4c4f-a7e2-a8481efb9634
# 이때 위위셀에서 x값을 4로 바꾸면 z는 6으로 바뀔 것
# 그런데 새로운 셀에 x를 새로 정의할 순 없음
# 즉 위위셀 x값을 바꿔주면 관련된 셀까지 업데이트 되는 것이다. 

# ╔═╡ dd4a91bc-bdcb-467b-9a98-442577a475a6
# x="a" 이건 불가능
# 인터렉티브 노트북이어야 하기 때문에 플루토에서는 중복선언이 불가능하다.
# 변수이름을 중복사용 할 수 없다.

# ╔═╡ 9c8fb327-6a6e-499e-9122-80f248788b0c
#a=1
#b=1
#c=a+b
# 이렇게 하나의 셀에 여러 줄의 코드르 쓸 수 없음
...
# 이렇게 하나의 셀에 여러 줄의 코드를 작성할 수 있긴 함
begin
	k=1
	k=k+3
	k=k+1
...
md"현재 k는 $k 입니다.
이렇게 정의돼 있는 k를 이용하여 마크다운에 반영할 수 있다."
...
@bind vote Radio(["이재명","윤석열","심상정"])
# 이재명, 윤석열, 심상정이 포함된 라디오 버튼을 만들고 -> 버튼의 클릭결과는 vote에 저장됨
...
# ╔═╡ b9f3f4e1-ef1f-413c-a0fa-dd8f2a3aca74
# 여기서는 else if가 아니라 elseif로 사용해야 한다.

# ╔═╡ eba268c4-62c5-448c-a937-d2ab423d8335
md"당신의 선택: $vote"

# ╔═╡ a3309069-7b48-4503-be34-abb41ee98cf4
# 인터렉티브 노트북이기 때문에 라디오 버튼누르는 결과에 따라 관련된 셀들도 모두 최신 업데이트 된다

# ╔═╡ 620e9bc4-982a-445c-8a84-591d77efadaf
# ------------------------------------------------------------ #
...
# ╔═╡ b1cca92a-9f72-4b8b-9ffb-7cb36b044d3b
# 체크를 하면 true로 체크 하지 않으면 false로 출력
...
# ╔═╡ f6b6a35c-43ff-4860-84b4-c26dcad4b0d4
# 체크하지 않으면 chckbx 자리가 false이기 때문에 if문이 실행되지 않아서 md가 출력되지 않는다.

# ╔═╡ 9135c41e-8318-4ced-89cd-59446ac59a41
# ----------------------------------------------------------------- # 
...
# ╔═╡ addc9a8b-d4fc-4e22-b0c2-c04280940f52
# 이렇게 소문자로 반환시켜준다.
...
# ╔═╡ f2a7ceb5-2340-43e9-8554-73fa6997c59e
# 보이지 않게 해준다.

# ╔═╡ 7cb4e850-b103-4699-bf40-0f4811648d8c
passwd

# ╔═╡ 55b8afa6-6e2d-4e19-9bc0-25fca7e6ae63
#------------------------------------------------#
...
# ╔═╡ 1b472d75-c9be-4fa6-9c2a-6f902b68aefc
# 선택한 것을 다른 문자열로 치환하여 사용할 수 있도록.
...
# ╔═╡ 34aba56d-3c05-4904-80c6-6db575a9b0a3
# 기호1을 선택했지만, 기호3으로 vote3에 저장되는 것이 아니라 이재명으로 저장된다
...
# ╔═╡ a27edb8c-bb0d-4779-ac83-b996d45977ad
# Select와 다른 점
# shift 누르고 클릭하면 다중으로 선택할 수 있다.
# 처음 커서가 놓아지는 곳을 통계전산으로 하고 싶을 때 default로 설정가능하다
...
# ╔═╡ 270c6ced-44fc-47d9-9023-3d61911978b1
@bind val3 Slider(50:100, show_value = true)

# ╔═╡ 5fe9e735-b0e9-4365-ac00-2363cfd73ac8
# show_value=true
# 추가 입력해주면 슬라이더 옆에 해당 숫자를 보여준다.

# ╔═╡ 889982e3-d360-42a2-8c39-69dc2b4a58db
val1

# ╔═╡ 21c6b625-a0a9-4fdf-a7a9-f1de14823c83
val3

# ╔═╡ accb9ca2-1259-4f43-9a28-81734baff557
val1+val3

# ╔═╡ 7cd41c5c-924c-4cab-a50f-a4aa3facc2e1
#--------------------------------------------------------------#
