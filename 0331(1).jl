...
md"""
(증명) 
- 이 수업에서는 증명의 편의성을 위하여 $X$가 연속형이고 $F$가 순증가함수임을 가정한다. 
- 하지만 일반적인 경우에도 성립한다.  
"""

# ╔═╡ 9976f760-c97f-4680-bd9c-a16914c720ac
md"""
- cdf : 주어진 확률 변수가 특정 값보다 작거나 같은 확률을 나타내는 함수이다. 
- 아래에서는 특정 값을 c라고 상정하신 것 같음
"""

# ╔═╡ 7c38c36f-7d9c-475e-b707-cd9d78df4c02
md"""
(1단계) 
- 먼저 $F(X)\overset{d}{=}U$임을 보이자. 
"""
...
# ╔═╡ d543cba5-fa38-402c-bd47-30fa8a5b0b93
md"""
-$F(X)\overset{d}{=}U$ 임을 확인했다.
"""
...
# ╔═╡ 3a173fca-5fe4-4df6-9fe6-662885c522d1
md"""
`-` 두 확률변수 $X$, $Y$가 있을때, 각각의 cdf가 같으면 $X$와 $Y$의 분포가 같다고 볼 수 있음.
"""
...
# ╔═╡ 778eb6a5-1269-4d09-97f2-150d905ae01f
md"""
-----
"""

# ╔═╡ 869c2174-2bc9-49f5-a31d-540faf4a75bd
md"""
-----
"""

# ╔═╡ c20ed8ff-b59b-482f-aa4f-12d345c82cb3
md"""
-----
"""

# ╔═╡ 2a72f112-a6b4-4707-8d9b-d03dd219a750
md"""
-----
"""
...
begin
	...
	scatter!([X[i]],[Y[i]],color="blue") # 그때 그때 사격하는 점
end 
...
begin
	scatter(X,Y,xlim=(-12,12),ylim=(-12,12),color="white",alpha=0.2)
	scatter!([1.2],[3.4],color="red") # 목표점
	θ = 0:0.01:2π
	plot!( r.*cos.(θ) .+ 1.2 , r.*sin.(θ) .+ 3.4 , color="blue")
	# θ = 0:0.01:2π에 해당되는 모든 점들을 연결해준 것
	# 삼각함수로 좌표 찍어준 원리
	_index = [(X[i]-1.2)^2+(Y[i]-3.4)^2 ≤ r^2 for i in 1:N]
	_prob= sum(_index)/N
	scatter!(X[_index],Y[_index],alpha=0.2,color="green")
end 
